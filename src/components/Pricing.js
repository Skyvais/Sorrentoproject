...
import BannerImage from '../banners/jessica-suetta-xkAcWDG0nbU-unsplash.jpg'
...
export function Pricing(props) {
    return (
        <div className="Pricing">
            <Banner image={BannerImage} text="Ejoy your weekend away..." />
            <h2>Pricing</h2>
            <div className="grid">
                <div className="card">
                    <h3>Winter</h3>
            ...
            <Link to="/contact" className="button">Book your stay now</Link>
